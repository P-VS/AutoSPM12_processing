function [delfiles,keepfiles] = my_spmbatch_denoise(sub,ses,task,datpath,params)
...
ppparams.subfuncstring = [ppparams.prefix ppparams.subfuncstring];
...
if params.denoise.do_ICA_AROMA || params.denoise.do_DENN
    ...
    [Vmask,fmaskdat,~] = my_spmbatch_readSEfMRI(nsubfuncstring,ppparams.ppfuncdir,0,ppparams,10);
...
if params.denoise.do_aCompCor
    ...
    for ie=ppparams.echoes
        ...
        [tedata{ie}.Vfunc,tedata{ie}.wfuncdat,ppparams.funcfile{ie}] = my_spmbatch_readSEfMRI(nsubfuncstring,ppparams.ppfuncdir,0,ppparams,Inf);
    end
